    ...
    for fold, (train_val_idx, test_idx) in enumerate(kfold.split(X, y), 1):
        ...
        try:
            ...
            X_train, X_val, y_train, y_val = train_test_split(
                X_train_val, y_train_val, test_size=0.1, random_state=args.seed
            )
            ...
            all_f1s.append(f1)
            all_uars.append(uar)
            all_confusion_matrices.append(cm)  # New: add confusion matrix
