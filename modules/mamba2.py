...
class Mamba2(nn.Module):
    def __init__(self, d_model: int,
                 ...
                 pad_vocab_size_multiple: int = 16, ):
        super().__init__()
        args = Mamba2Config(d_model, n_layer, d_state, d_conv, expand, headdim, chunk_size, vocab_size,
        ...
        nn.init.normal_(self.dt_bias, mean=-5.0, std=0.1)
